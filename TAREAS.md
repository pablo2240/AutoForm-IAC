...
- [x] **[LLM-03]** Implementar **deduplicación de coordenadas destino** en el plan de mapeo. Si dos entradas apuntan a la misma celda `(hoja, fila_destino, columna_destino)`, conservar solo la primera y descartar las duplicadas.
